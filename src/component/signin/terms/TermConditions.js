...
import SVGImg from '../../../assets/undraw_accept_terms_re_lj38.svg';
...
{/* 
      ...
      />
        ...
        <Text
          ...
          By Selecting "I Agree" blew, I have reviewed{"\n"}
           and agree to the <Text style={{color:'blue'}}>Term of Use</Text> and {"\n"}
           acknowledge the  <Text style={{color:'blue'}}>Privacy Notice</Text>. I am at{"\n"} 
